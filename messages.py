...
START = f'🙋‍♂ Добро пожаловать в бот "Sub VP". Я создан для того, чтобы помогать тебе получать взаимных подписчиков на твой канал. Перед началом использования бота, обязательно прочитай небольшую [инструкцию по использованию бота, а также правила]({LINK_TO_INTRODUCTION_AND_RULES})'
